...
import com.sdlh.demo.algorithm.dsp.filter.IHighPassFilter;
import com.sdlh.demo.algorithm.dsp.filter.ILowPassFilter;
 ...
 */
public class IIRFilter implements IHighPassFilter, ILowPassFilter {

    @Override
    public double[][] highPassStaticParameter() {
    ...
    @Override
    public double[][] highPassDynamicParameter(double freq) {
        return new double[0][];
    }

    @Override
    public double[][] lowPassStaticParameter() {
        double[][] sos = new double[][]{{1, 2, 1, 1, -1.99913900721990490000, 0.99918150500520764000},
                {1, 2, 1, 1, -1.99751694173024830000, 0.99755940503361140000},
                {1, 2, 1, 1, -1.99593588662255180000, 0.99597831631577549000},
                {1, 2, 1, 1, -1.99442052977360620000, 0.99446292725330698000},
    ...
    @Override
    public double[][] lowPassDynamicParameter(double freq) {
        return new double[0][];
    }

    @Override
    public double[] highPass(double[] data, double[][] parameter) {
        return data;
    }

    @Override
    public double[] lowPass(double[] data, double[][] parameter) {
        return data;
    }
}
